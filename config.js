...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "HUNTER-XMD~HZZHgCIA#OqPl5UM_LdGF1gqvF5EKVr8e1xPxdtPGVm_fiOwufWk",
// add your Session Id 
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || ">`*§ PROFESSOR*`",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/ufdd01.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> `*PROFESSOR SEES*⚡",
// add alive msg here 
